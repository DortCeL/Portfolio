      ...
      <div className="relative z-[2] mx-auto max-w-5xl">
        ...
        <ul className="mt-8 flex flex-wrap gap-3">
          {profile.skills.map((skill, i) => (
            <li
              key={skill}
              className="border-2 border-manga-black bg-white px-3 py-2 text-xs font-black tracking-wide text-manga-black uppercase shadow-[3px_3px_0_#0c0c0d] transition hover:-translate-y-0.5 hover:bg-manga-yellow"
              style={{
