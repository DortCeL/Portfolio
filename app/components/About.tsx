        ...
        <div>
          ...
          <Reveal variant="up" delay={120}>
            <div className="mt-8 space-y-4 text-base leading-relaxed text-manga-black/80 sm:text-lg">
              ...
              <p>
                I genuinely just like building things. Doesn&apos;t really
                matter what- a script, a small app, whatever. Lately i&apos;ve
                been working on my thesis: stance detection on Bangla social
                media text using transformer models. Basically trying to get a
                model to understand what people actually mean when they&apos;re
                going back and forth in the comments. But I&apos;m also working
                on a few side projects that are fun.
              </p>
              <p>
                I&apos;m still early in this journey and learning fast, and
                I&apos;m currently looking for internships or a junior software
                engineer role : somewhere I can keep building and actually grow.
              </p>
